...
export class AppearanceSection {
    ...
    queryElements() {
        ...
        this.elements = {
            ...
            bubbleToggle: get('bubble-toggle')
    ...
    bindEvents() {
        ...
        if (this.elements.bubbleToggle) {



            this.elements.bubbleToggle.addEventListener('change', (e) => this.fire('onBubbleChange', e.target.checked));
