...
<div class="setting-group">
    ...
    <p class="setting-info">
        ...
        <span id="app-current-version">v0.0.0</span>
        <span id="app-update-status" style="font-size: 13px; margin-left: 8px; font-weight: normal;"></span>
    </p>
    
    <div style="display: flex; gap: 16px; margin-top: 8px; flex-wrap: wrap;">
        <a href="https://github.com/xusonfan/gemini-nexus" target="_blank" class="github-link" style="margin-top: 0;">
        ...
        <a href="https://github.com/xusonfan/gemini-nexus/blob/main/README.md" target="_blank" class="github-link" style="margin-top: 0;">
