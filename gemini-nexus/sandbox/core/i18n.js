...
export const translations = {
    en: {
        ...
        "explainPageContext": "Explain With Page Context",
        "explainPageContextDesc": "Include current page content when using Explain. Shift still works when this is off.",
        ...
        "showFloatingBubble": "Floating Bubble",
        ...
        "shortcutSummarizePage": "Summarize Page",
        "shortcutOCR": "OCR (Extract Text)",
        "shortcutTranslate": "Screenshot Translate",
        "shortcutSnip": "Snip (Capture Area)",
        "shortcutPageChat": "Chat with Page",
    ...
    zh: {
        ...
        "explainPageContext": "解释时带网页上下文",
        "explainPageContextDesc": "使用解释时自动包含当前网页内容；关闭后仍可按住 Shift 临时启用。",
        ...
        "shortcutSummarizePage": "总结网页",
        "shortcutOCR": "OCR (文字提取)",
        "shortcutTranslate": "截图翻译",
        "shortcutSnip": "区域截图",
        "shortcutPageChat": "与当前网页对话",
